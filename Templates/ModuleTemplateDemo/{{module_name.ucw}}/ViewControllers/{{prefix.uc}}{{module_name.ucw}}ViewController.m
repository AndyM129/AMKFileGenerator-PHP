//
//  {{prefix.uc}}{{module_name.ucw}}ViewController.m
//  {{project_name}}
//
...
#import <{{project_name}}/{{prefix.uc}}Router.h>

@interface {{prefix.uc}}{{module_name.ucw}}ViewController ()

@end

@implementation {{prefix.uc}}{{module_name.ucw}}ViewController
...
- (void)test {
    ...
    [titles addObject:@"推荐"];
    [routerUrls addObject:[{{prefix.uc}}Router routerUrlWithPath:@"/view/recommend/page" params:nil]];

    [titles addObject:@"关注"];
    [routerUrls addObject:[{{prefix.uc}}Router routerUrlWithPath:@"/view/follow/page" params:nil]];
    
    [titles addObject:@"战队"];
    [routerUrls addObject:[{{prefix.uc}}Router routerUrlWithPath:@"/view/team/page" params:nil]];
    ...
    [routerUrls enumerateObjectsUsingBlock:^(NSString * _Nonnull routerUrl, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [button addBlockForControlEvents:UIControlEventTouchUpInside block:^(id  _Nonnull sender) {
            [{{prefix.uc}}Router performRouterUrl:routerUrl params:nil error:nil];
        }];
